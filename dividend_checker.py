...
class DividendChecker:
    def __init__(self, supabase_client, last_n_day="7"):
        ...
        self.start_date = (datetime.today() - timedelta(days=last_n_day - 1)).strftime("%Y-%m-%d")
    ...
    def upsert_to_db(self):
        ...
        try:
            self.supabase_client.table("idx_dividend").upsert(self.retrieved_records).execute()
